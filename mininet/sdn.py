...
class NetworkTopo( Topo ):
    ...
    def build( self, **_opts ):
        ...
        self.addLink( cr1, dr1, intfName1='cr1-eth1',intfName2='dr1-eth2', params1={ 'ip' : '192.168.100.1/30' },params2={ 'ip' : '192.168.100.2/30' } )
        self.addLink( cr1, dr2, intfName1='cr1-eth2',intfName2='dr2-eth2', params1={ 'ip' : '192.168.100.5/30' },params2={ 'ip' : '192.168.100.6/30' } )
        ...
        self.addLink( cr1, srv, intfName1='cr1-eth5',params1={ 'ip' : '10.0.0.1/24' })
...
cmap = { 'cr1': ccr, 'ap11':c0, 'ap12':c0, 'ap21':c0, 'ap22':c0, 'as1':cdr1, 'as2':cdr2 }		
...
def addRoutes(net):
    ...
    net['cr1'].cmd( 'ip route add 192.168.111.0/24 via 192.168.100.2')
    net['cr1'].cmd( 'ip route add 192.168.222.0/24 via 192.168.100.6')
...
def run():
    ...
    net["cr1"].cmd( 'ovs-vsctl add-port "cr1" cr1-eth1')
    net["cr1"].cmd( 'ovs-vsctl add-port "cr1" cr1-eth2')
